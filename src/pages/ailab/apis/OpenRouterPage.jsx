      ...
      <Block title="Watch first" titleColor="#EF4444">
        ...
        <Block>
          ...
          <Steps color={color} items={[
            ...
            { n: '4', title: 'Switch models by changing one parameter', body: "To use Claude instead: model='anthropic/claude-3.5-sonnet'\nTo use Gemini: model='google/gemini-3.5-flash-001'\nTo use GPT-5.5: model='openai/gpt-5.5'\nEvery other line of code stays identical. This is the core value — experiment with any model without rewriting your integration." },
            { n: '5', title: 'Add fallback routing for reliability', body: "Pass a list of models: OpenRouter tries the first, falls back to the next if unavailable. In the extra_body param: extra_body={'models': ['openai/gpt-5.5', 'anthropic/claude-3.5-sonnet', 'meta-llama/llama-4-scout:free']}. Your app never goes down because one provider had outage." },
          ]} />
        </Block>
        <Block>
        ...
        <Block>
          ...
          <CardGrid color={color} items={[
            ...
            { name: 'Cost optimization routing', desc: 'Route simple questions to a cheap fast model (Llama 4 Scout at $0.03/M tokens) and complex reasoning tasks to a premium model (Claude Sonnet 5 at $3/M tokens). Same codebase, automatic cost management.' },
            ...
            { name: 'Multi-model comparison tools', desc: 'Build a tool that sends the same prompt to GPT-5.5, Claude, Gemini, and Llama simultaneously and displays all responses side by side. Only possible with OpenRouter\'s unified interface — building this with direct APIs would take weeks.' },
          ]} />
        </Block>
        <ProjectTask
