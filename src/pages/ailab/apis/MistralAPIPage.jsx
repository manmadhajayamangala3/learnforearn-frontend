      ...
      <Block title="Watch first" titleColor="#EF4444">
        ...
        <Block>
          ...
          <CardGrid color={color} items={[
            { name: 'Mistral Large', desc: 'Flagship frontier model. Best reasoning, complex code generation, nuanced instruction following. Comparable to GPT-5.5 for most tasks. Priced at $2/$6 per 1M tokens — significantly cheaper than GPT-5.5 at $5/$15. Best for production pipelines where quality matters most.' },
...
response = client.fim.complete(
  ...
  max_tokens=256
        ...
        <Block>
          ...
          <Compare color={color} items={[
            { label: 'Cost per token', badge: 'Mistral wins', body: 'Mistral Large: $2/$6 per 1M tokens. OpenAI GPT-5.5: $5/$15 per 1M tokens. Mistral is 40-60% cheaper than OpenAI for equivalent flagship-tier tasks. Mistral Small at $0.10/$0.30 is competitive with GPT-5.5-mini. For high-volume production systems, Mistral\'s pricing advantage compounds significantly.' },
            { label: 'Raw speed / latency', badge: 'Groq wins by far', body: 'Groq (running Llama/Mixtral on custom LPU hardware): 500-800 tokens/second. Mistral La Plateforme: ~80-120 tokens/second. OpenAI GPT-5.5: ~50-80 tokens/second. For latency-critical applications, Groq is the choice. For production quality where speed matters less than model quality or cost, Mistral.' },
            { label: 'Code generation quality', badge: 'Mistral has Codestral', body: "Mistral Codestral is a dedicated code model — it uniquely supports fill-in-the-middle completion, has 128K context, and is trained on 80+ languages. OpenAI's o-mini and GPT-5.5 are strong on code reasoning but are general models. For IDE completion, FIM tasks, and cost-effective code generation, Codestral has a genuine edge." },
