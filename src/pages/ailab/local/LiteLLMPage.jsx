    ...
    <ToolPageShell toolColor={color} categoryLabel="Local AI">
      ...
      <Block title="Watch first" titleColor="#EF4444">
        ...
        <Block>
          ...
          <p className="tool-layout-block__para" style={{ marginBottom: 0 }}>The AI landscape in 2025 has dozens of competitive providers. OpenAI GPT-4o leads in general capability. Claude leads in long context and coding. Gemini Flash is the fastest and cheapest. Groq runs inference at 500+ tokens/second. Ollama runs models locally for free. The right provider depends on your use case, budget, and latency requirements — and that can change over time. Building your app tightly coupled to one provider's SDK is a liability. LiteLLM decouples your application logic from the provider completely. You configure which provider to use at the model name level — not at the code level. This is the same pattern that made database abstraction layers (like SQLAlchemy) a standard part of Python development.</p>
        </Block>
        <Block>
