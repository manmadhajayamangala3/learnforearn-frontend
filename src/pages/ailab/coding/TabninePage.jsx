      ...
      <Block title="Watch first" titleColor="#EF4444">
        ...
        <Block>
          ...
          <CardGrid color={color} items={[
            ...
            { name: 'Tabnine Chat', desc: 'AI chat sidebar available in VS Code, JetBrains, and Eclipse. Ask questions about your code, generate tests, request refactoring. Supports switchable underlying models including Claude and GPT-5.5.' },
        ...
        <Block>
          ...
          <CardGrid color={color} items={[
            ...
            { name: 'Pro — $12-15/month', desc: 'Full cloud completions, Tabnine Chat with switchable models (including Claude and GPT-5.5), local model access, and RAG-based personalization from your codebase.' },
