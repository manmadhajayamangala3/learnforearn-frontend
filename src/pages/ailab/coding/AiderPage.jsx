      ...
      <Block title="Watch first" titleColor="#EF4444">
        ...
        <Block>
          ...
          <CardGrid color={color} items={[
            ...
            { name: 'Multi-Model Support', desc: 'Run any model: Claude 4.x, GPT-5, Gemini 3.1 Pro, DeepSeek R1/V3, Grok 4, Ollama local models, and any OpenAI-compatible endpoint. Switch models per-session with --model.' },
        ...
        <Block>
          ...
          <Steps color={color} items={[
            ...
            { n: '4', title: 'Start Aider with your model', body: 'Run: GEMINI_API_KEY=your-key aider --model gemini/gemini-3.5-flash (for free Gemini). Or: ANTHROPIC_API_KEY=your-key aider --model sonnet (for Claude). Aider will display your repo structure and drop into interactive chat.' },
        ...
        <Block>
          ...
          <Compare color={color} items={[
            { label: 'Gemini 3.5 Flash (Google AI Studio)', badge: 'Free tier available', body: 'Get a free API key from aistudio.google.com — no billing required. Run: aider --model gemini/gemini-3.5-flash. The free tier has rate limits but is sufficient for learning projects and small codebases. Best zero-cost starting point.' },
            ...
            { label: 'Claude Sonnet (Anthropic)', badge: 'Best quality — paid', body: 'Claude Sonnet 5 / Claude 4 Sonnet is Aider\'s default recommended model and where it performs best on the benchmark. Pay-as-you-go. A typical coding session costs $0.10–$0.40. Worth it for real projects with complex multi-file changes.' },
            { label: 'Architect mode: Opus + Sonnet', badge: 'Premium — complex tasks', body: 'For very complex features, use --architect with Claude Opus as planner and Sonnet as coder: aider --architect --model claude-opus-4-8 --editor-model claude-sonnet-5. Opus designs the approach; Sonnet implements it efficiently.' },
          ]} />
        </Block>
        <Block>
          ...
          {[
            ...
            'aider --architect --model claude-opus-4-8 --editor-model claude-sonnet-5 — Opus plans, Sonnet codes',
            'aider --architect --model o1 --editor-model gpt-5.5 — OpenAI equivalent with reasoning model',
        ...
        <div className="tool-layout-task">
          ...
          <Steps color={color} items={[
            ...
            { n: '2', title: 'Start Aider and explore the repo', body: 'Run: GEMINI_API_KEY=your-key aider --model gemini/gemini-3.5-flash. In the chat, type /map to see Aider\'s repository map. Notice how it understands your entire file structure. Ask Aider: "What does this codebase do?" — it will summarize from the map.' },
            ...
            { n: '6', title: 'Use architect mode for a bigger task', body: 'For a complex multi-file change, restart with: aider --architect --model gemini/gemini-3.5-flash. Ask: "Separate the database logic from the business logic in this project into distinct modules." Architect mode plans the restructuring before writing a single line.' },
          ]} />
