    ...
    <ToolPageShell toolColor={color} categoryLabel="AI Foundations">
      ...
      <Block title="Watch first" titleColor="#EF4444">
        ...
        <Block>
          ...
          <Compare color={color} items={[
            { label: 'ChatGPT (GPT-5.5)', body: 'Responds well to conversational, natural prompts. Strong at following explicit formatting instructions. Good at generating code with explanations. Sometimes adds unnecessary caveats — use negative prompting to suppress them. Excellent at step-by-step explanations when asked.' },
            { label: 'Claude Sonnet 5', body: 'Prefers more context about your goal rather than just the immediate task. Gives more nuanced, balanced answers. Less likely to just tell you what you want to hear. Better at long document analysis. Responds well to "be critical" and "identify flaws" prompts — more honest about weaknesses.' },
