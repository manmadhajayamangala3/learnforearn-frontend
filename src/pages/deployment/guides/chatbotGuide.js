    ...
    steps: [
      {
        ...
        text: [
          ...
          '→ OpenAI API chatbot (GPT-4o, GPT-4o-mini, GPT-3.5)',
...
if __name__ == "__main__":
    demo.launch()`,
      ...
      },
      {
        ...
        text: [
          'OpenAI API chatbot:',
          '✅ Much better response quality (GPT-4o-mini is excellent)',
          '✅ Reliable and fast',
    ...
    steps: [
      {
        ...
        text: [
          ...
          '   DialoGPT-medium and GPT-4o-mini (via API) both work on free CPU.',
          '',
          'Notes on visibility:',
