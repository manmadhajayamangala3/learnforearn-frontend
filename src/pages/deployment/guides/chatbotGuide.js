    ...
    steps: [
      {
        ...
        text: [
          ...
          '→ OpenAI API chatbot (gpt-4o-mini, gpt-3.5-turbo)',
...
if __name__ == "__main__":
    demo.launch()`,
      ...
      },
      {
        ...
        text: [
          'OpenAI API chatbot:',
          '✅ Much better response quality (gpt-4o-mini is excellent value)',
          '✅ Reliable and fast',
    ...
    steps: [
      {
        ...
        text: [
          ...
          '   DialoGPT-medium runs locally on the free CPU. gpt-4o-mini runs on',
          '   OpenAI\'s servers via API — the Space only sends the request, so it',
          '   needs no heavy hardware either.',
          '',
          'Notes on visibility:',
