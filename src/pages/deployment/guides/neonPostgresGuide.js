    ...
    steps: [
      {
        ...
        text: [
          ...
          '',
          'Free tier:',
          '   0.5GB per project (5GB aggregate across 10 projects), data preserved',
          '   Free forever, no credit card',
          '   Note: the compute auto-suspends when idle (data is never lost) — the',
          '   first query after idle takes an extra moment to wake it up.',
        ],
        note: 'Neon is the best free PostgreSQL option for long-term student projects. Unlike Render PostgreSQL which expires after 30 days, Neon keeps your data permanently — its compute just sleeps when idle and wakes on the next query.',
      },
    ],
  },
